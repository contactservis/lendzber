    ...
    <div class="container block_01">
        ...
        <div class="left_block" style="margin-bottom: 90px;">
            ...
            <p>Механизм финансирования основан на краудфандинговой модели, когда множество инвесторов
                ...
                в результате чего собирается необходимый объем денежных средств для финансирования того или иного
                проекта.
        ...
        <div class="right_block">
            ...
            <p>Брокерское обслуживание в рамках сервиса ZБЕРОПОЛИС осуществляет Акционерное общество «Инвестиционная
                компания
                «НФК-Сбережения» – один из крупнейших брокеров Поволжья с 15-летним опытом работы на финансовом рынке.
                Компания оказывает
                финансовые услуги на всей территории Российской Федерации как физическим, так и юридическим лицам
                посредством удаленного заключения
                    ...
                    <div id="screen_slider_box">
                        <div class="screen_slider_box_item">
                            ...
                            <div class="block_punkt">
                                ...
                                свои средства в различные направления: от предприятий малого и среднего бизнеса до
                                государственных облигаций.
                            </div>
                            <p>Инвестором может стать любое физическое или юридическое лицо, зарегистрированное на
                        ...
                        <div class="screen_slider_box_item">
                            ...
                            <p>Эмитентом может стать любая коммерческая организация или индивидуальный предприниматель,
                                зарегистрированные на территории Российской Федерации.</p>
                        </div>
                    </div>
                </div>
                <div class="arrow">
        ...
        <div class="right_block">
            <div class="list_why">
                ...
                <div class="list_why_item">
                    ...
                    <br>Регистрация, идентификация и заключение договора проходят в режиме онлайн (с использованием
                    сервисов ЕСИА/СМЭВ).
                </div>
                <div class="list_why_item">
                    <span>Защита от потерь</span>
                    <br>Ваши инвестиции распределяются между различными, не зависящими друг от друга компаниями, что
                    позволяет диверсифицировать вложения и снизить риск.
                </div>
            </div>
        </div>
        <div class="left_block">
            <div class="list_why">
                ...
                <div class="list_why_item">
                    ...
                    <br>Исчисление, удержание и уплату налогов в интересах инвесторов-физических лиц производит
                    налоговый агент.
                </div>
            </div>
        </div>
        <div class="clear"></div>
        <h1 style="text-align: center; margin-top: 75px;" id="header_podpiski">Хотите первым узнать <br>о запуске
            уникального проекта <br>ZБЕРОПОЛИС?</h1>
        <div id="podpiska">
...
<div id="popup_fade" class="gradient">
    <div class="popup_content">
        ...
        <h3>Чтобы стать участником проекта ZБЕРОПОЛИС и получить возможность инвестировать средства, нужно открыть
            брокерский счет в АО "НФК-Сбережения". </h3>
        ...
        <p>Чтобы получить возможность привлечения финансирования с помощью проекта ZБЕРОПОЛИС, нужно связаться с
            нами:</p>
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/51068129" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
</body>
</html>